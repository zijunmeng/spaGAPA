...
DEFAULT_GTF = "/s1/SHARE/00_ref_genecode/refdata-gex-GRCh38-2024-A/genes/genes.gtf.gz"
...
def write_r_script(args: argparse.Namespace, paths: dict[str, Path], tools: dict[str, str]) -> Path:
    ...
    chr_fn = mouse_chromosomes if args.species == "mouse" else human_chromosomes
    chrs = r_vector(chr_fn())
    r_code = f"""
